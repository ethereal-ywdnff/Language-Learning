...
message = ""
...
{- This is the type of thing that will happen when testing your code. Note
 ...
 -}
main = do
    let a = encodeMessage x2a enigma1
    let b = encodeMessage a enigma1
    let c = encodeMessage x2b enigma2
    let d = encodeMessage c enigma2
