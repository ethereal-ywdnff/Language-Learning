...
public class GameOver_destroyed extends JFrame{
    public GameOver_destroyed() {
        setTitle("Game Over");
        ...
        try {
            ...
            JLabel label = new JLabel("<html><div style='text-align: center'>Game Over.<br>Your " +
                    "spaceship has been destroyed<br>" + badge + "</div></html>", SwingConstants.CENTER);
