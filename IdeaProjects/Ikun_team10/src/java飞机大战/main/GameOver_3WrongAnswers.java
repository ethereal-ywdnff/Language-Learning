...
public class GameOver_3WrongAnswers extends JFrame{
    public GameOver_3WrongAnswers() {
        setTitle("Game Over");
        ...
        try {
            ...
            JLabel label = new JLabel("<html><div style='text-align: center'>Game Over.<br>You " +
                    "have answered 3 questions wrong.<br></div></html>", SwingConstants.CENTER);
